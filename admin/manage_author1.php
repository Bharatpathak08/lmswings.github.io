          ...
          <table class="table-bordered" width="550px" style="text-align: center; margin-left:-50px; color:whitesmoke;">
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn"><a href="edit_author1.php?aid=<?php echo $row['author_id'];?>">Edit</a></button>
								<button class="btn"><a href="delete_author1.php?aid=<?php echo $row['author_id'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
