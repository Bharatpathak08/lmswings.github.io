  ...
  <div class="dropdown-content">
    ...
    <div class="sidebar" >
      <ul>
        ...
        <li style="margin-top:-5px;"> <a class="sidebar-list-item active" href="manage_cat1.php"> <i class="fas fa-toolbox icon"></i><em>Manage Category</em></a>
        </li>
    ...
    <main class="content">
      <div class="main-header">
        ...
        <div class="main-form">
          ...
          <input type="mobile" name="cat_name" id="fdescription" placeholder="Category Name" value="<?php echo $cat_name; ?>" required  >


            <input type="submit" name="update_cat" id="fsubmit" value="Update Category" class="button">
