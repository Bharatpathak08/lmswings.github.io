  ...
  <div class="dropdown-content">
    ...
    <div class="sidebar" >
      <ul>
        ...
        <li style="margin-top:-5px;"> <a class="sidebar-list-item active" href="add_book1.php"> <i class="fas fa-toolbox icon"></i><em>Add New Book</em></a>
        </li>
      ...
      <div class="main-header" >
        ...
        <div class="main-form">
          <form name="event" action="" method="post">
            ...
            <input type="mobile" name="book_author" id="fdescription" placeholder="Author ID" required >
            
            <input type="mobile" name="book_category" id="fdescription" placeholder="Category ID" required >

            <input type="mobile" name="book_no" id="fdescription" placeholder="Book Number" required >

            <input type="mobile" name="book_price" id="fdescription" placeholder="Book Price" required >

            <input type="submit" name="add_book" id="fsubmit" value="Add Book" class="button">
