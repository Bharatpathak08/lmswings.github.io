<?php
	...
	$book_no = "";
	$student_name = "";
	$query = "select issued_books.book_name,issued_books.s_no,issued_books.book_author,issued_books.book_no,users.name from issued_books left join users on issued_books.student_id = users.id where issued_books.status = 1";
?>
