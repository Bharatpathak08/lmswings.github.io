	...
	<i class="fa fa-bars"></i>
	  ...
	  <i class="fas fa-user-circle icon" ></i>Welcome: <?php echo $_SESSION['name'];?>
			...
			<li class="nav-item" style="margin-top:8px;margin-right:10px;">
			  ...
			  <div class="dropdown">
  <button class="dropbtn gradient-text active1" style="font-weight:700;">Authors</button>
  ...
  <div class="dropdown-content">
    ...
    <div class="sidebar" >
      <ul>
        ...
        <li style="margin-top:-5px;"> <a class="sidebar-list-item active" href="manage_author1.php"> <i class="fas fa-toolbox icon"></i><em>Manage Author</em></a>
        </li>
      ...
      <div class="main-header">
        ...
        <div class="main-form">
          <form name="event" action="" method="post">
            <input type="text" name="author_name" id="ftitle" placeholder="Author Name" value="<?php echo $author_name; ?>" required>
            
            <input type="submit" name="update_author" id="fsubmit" value="Update Author" class="button">
