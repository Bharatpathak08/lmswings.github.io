...
<body>
  ...
  <div class="dropdown-content">
    ...
    <main class="content">
	<div class="main-header" style="max-width:700px;">
        <div class="main-title">
          <h1>Manage Books</h1>
        </div>
        <div class="main-form">
          <form name="event">
          <table class="table-bordered" width="620px" style="text-align: center; margin-left:-80px; color:whitesmoke;">
						<tr>
                            <th>Name</th>
							<th>Author</th>
							<th>Category</th>
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn" name=""><a href="edit_book1.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn"><a href="delete_book1.php?bn=<?php echo $row['book_no'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
