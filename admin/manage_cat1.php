          ...
          <table class="table-bordered" width="550px" style="text-align: center; margin-left:-50px; color:whitesmoke;">
						...
						while ($row = mysqli_fetch_assoc($query_run)){
							...
							<tr>
								...
								<td><button class="btn"><a href="edit_cat1.php?cid=<?php echo $row['cat_id'];?>">Edit</a></button>
								<button class="btn"><a href="delete_cat1.php?cid=<?php echo $row['cat_id'];?>">Delete</a></button></td>
							</tr>
							<?php
						}
					?>
