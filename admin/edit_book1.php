  ...
  <div class="dropdown-content">
    ...
    <div class="sidebar" >
      <ul>
        ...
        <li style="margin-top:-5px;"> <a class="sidebar-list-item active" href="manage_book1.php"> <i class="fas fa-toolbox icon"></i><em>Manage Books</em></a>
        </li>
    ...
    <main class="content">
      <div class="main-header">
        ...
        <div class="main-form">
          ...
          <input type="mobile" name="book_no" id="fdescription" placeholder="Book Number" value="<?php echo $book_no;?>" disabled  >

            <input type="text" name="book_name" id="ftitle" placeholder="Book Name" value="<?php echo $book_name;?>" required>
            
            <input type="mobile" name="author_id" id="fdescription" placeholder="Author ID"  required >
            
            <input type="mobile" name="cat_id" id="fdescription" placeholder="Category ID"  required >

            

            <input type="mobile" name="book_price" id="fdescription" placeholder="Book Price" value="<?php echo $book_price;?>"  required >

            <input type="submit" name="update" id="fsubmit" value="Update Book" class="button">
